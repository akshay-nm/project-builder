...
import { EstimateNode, ExpandCollapseNode } from './types';
...
function filterCollapsedChildren(dagre: Dagre.graphlib.Graph, node: ExpandCollapseNode) {
